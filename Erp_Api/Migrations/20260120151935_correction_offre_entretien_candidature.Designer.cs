...
namespace Erp_Api.Migrations
{
    ...
    [Migration("20260120151935_correction_offre_entretien_candidature")]
    partial class correction_offre_entretien_candidature
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Erp_Api.Models.Entity.Tables.Entitees.Offre", b =>
                {
                    ...
                    b.Property<int?>("EntrepriseId")
                        .HasColumnType("integer")
                        .HasColumnName("off_entreprise_id");
            ...
            modelBuilder.Entity("Erp_Api.Models.Entity.Tables.Entitees.TypeContrat", b =>
                {
                    ...
                    b.ToTable("t_e_type_contrat_tco", "erp");
                });

            modelBuilder.Entity("Erp_Api.Models.Entity.Tables.Entitees.TypeEntretien", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("Libelle")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("ten_libelle");

                    b.HasKey("Id");

                    b.ToTable("t_e_type_entretien_ten", "erp");
                });
            ...
            modelBuilder.Entity("Erp_Api.Models.Entity.Tables.Entitees.Offre", b =>
                {
                    ...
                    b.HasOne("Erp_Api.Models.Entity.Tables.Entitees.TypeContrat", "TypeContrat")
                        .WithMany("Offres")
